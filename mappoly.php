	...
	if($_SERVER["REQUEST_METHOD"])
	{
		...
		switch ($method_name) 
		{
		  case 'GET':
			 ...
			 //$check_user="insert table2 SET order_id = $battery_value, gps_lat = $lattitude, gps_long = $longitude  WHERE cust_id = $client_id";
			 
			 $check_user="INSERT INTO `table2`(`cust_id`, `order_id`, `gps_lat`, `gps_long`) VALUES ($client_id,$battery_value,$lattitude,$longitude)";
