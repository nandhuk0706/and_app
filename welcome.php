...
<html lang="en">
  ...
  <body>
    ...
    $check_user="select * from temp_members_db WHERE email='$user_email'AND password='$user_pass'";
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 f-about">
						<a href="index.html"><h1><span>LEEP Technologies</span></h1></a>
						<p>LEEP Technologies is a two decade old company with in-depth knowledge
					...
					<div class="col-md-4 f-contact">
						...
						<p><i class="fa fa-home"></i>  LEEP Technologies PVT LTD 414/B,Rangopandith Agraharam ,Hosur-635109  <br>
							Tamil Nadu, Ind</p>
					</div>
				</div>
			</div>
