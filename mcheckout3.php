...
<?php
                        echo "Favorite color is " . $_SESSION["recharge_value"];
                        ?>
<!DOCTYPE html>
<html lang="en">
  <head>
            ...
            <div class="login-panel panel panel-success">
                <div class="panel-heading">
                   ...
                   &nbsp  &nbsp   &nbsp  &nbsp   <b>OrderID:  </b>
                     &nbsp  &nbsp  &nbsp  &nbsp<input id="ORDER_ID" tabindex="1" maxlength="20" size="20" name="ORDER_ID" autocomplete="off" value="<?php echo "ORDS" . rand(10000,99999999)?>">
                        </br></br>
                        
                 &nbsp  &nbsp  &nbsp  &nbsp   &nbsp  &nbsp<b>CustID: </b>&nbsp  &nbsp  &nbsp  &nbsp
                    <input id="CUST_ID" tabindex="2" maxlength="12" size="12" name="CUST_ID" autocomplete="off" value="<?php echo rand(10000,99999999)?>"></br></br>
                &nbsp  &nbsp  &nbsp  &nbsp    &nbsp  &nbsp&nbsp  &nbsp<b>Type: </b>&nbsp  &nbsp  &nbsp  &nbsp
                 ...
                 &nbsp  &nbsp  &nbsp  &nbsp   &nbsp  &nbsp &nbsp  &nbsp &nbsp   <b>Id: </b>&nbsp  &nbsp  &nbsp  &nbsp &nbsp
                  ...
                  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp  &nbsp &nbsp<b>Price: </b>&nbsp  &nbsp  &nbsp  &nbsp
                    <input title="TXN_AMOUNT" tabindex="10"  name="TXN_AMOUNT" value="<?php echo 1960 ?>"readonly></br></br>
