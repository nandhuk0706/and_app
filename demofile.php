                ...
                <div class="panel-heading">
                  ...
                  <div class="panel-body">
                    <form role="form" method="post" action="pgRedirect.php">
                        ...
                        <table border="1">
                            <tr>
                                ...
                                <td><input id="ORDER_ID" tabindex="1" maxlength="20" size="20" name="ORDER_ID" autocomplete="off" value="<?php echo "ORDS" .$order_id?>"></td>
                            </tr>
                            <tr>
                                <td> <b>CustID: </b> </td>
                            ...
                            <tr>
                                ...
                                <td> <input id="CHANNEL_ID" tabindex="4" maxlength="12" size="12" name="CHANNEL_ID" autocomplete="off" value="WEB"></td>
                            </tr>
                            <tr>
                                <td><b>Price: </b> </td>
                                <td><input title="TXN_AMOUNT" tabindex="10" type="text" name="TXN_AMOUNT" value="1"></td>
                            </tr>
                        </table>
                        </div>
                    <b>OrderID:  </b>
                    <input id="ORDER_ID" tabindex="1" maxlength="20" size="20" name="ORDER_ID" autocomplete="off" value="<?php echo "ORDS" .$order_id?>">
                        </br></br>
                                  <b>CustID: </b>          
                    ...
                    <input id="CHANNEL_ID" tabindex="4" maxlength="12" size="12" name="CHANNEL_ID" autocomplete="off" value="WEB"></br></br>
                                    <b>Price: </b>          
                    <input title="TXN_AMOUNT" tabindex="10" type="text" name="TXN_AMOUNT" value="1"></br></br>
